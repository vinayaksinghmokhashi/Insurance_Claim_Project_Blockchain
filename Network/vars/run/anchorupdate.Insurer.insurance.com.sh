...
jq '.channel_group.groups.Application.groups."Insurer-insurance-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.64.39.89","port": 7004}]},"version": "0"}}' insurancechannel_current_config.json > insurancechannel_modified_anchor_config.json
