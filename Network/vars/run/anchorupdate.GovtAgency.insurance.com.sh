...
export CORE_PEER_ADDRESS=10.64.39.89:7006
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/GovtAgency.insurance.com/peers/peer1.GovtAgency.insurance.com/tls/ca.crt
export CORE_PEER_LOCALMSPID=GovtAgency-insurance-com
export CORE_PEER_MSPCONFIGPATH=/vars/keyfiles/peerOrganizations/GovtAgency.insurance.com/users/Admin@GovtAgency.insurance.com/msp
export ORDERER_ADDRESS=10.64.39.89:7012
export ORDERER_TLS_CA=/vars/keyfiles/ordererOrganizations/insurance.com/orderers/orderer1.insurance.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."GovtAgency-insurance-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.64.39.89","port": 7006}]},"version": "0"}}' insurancechannel_current_config.json > insurancechannel_modified_anchor_config.json
