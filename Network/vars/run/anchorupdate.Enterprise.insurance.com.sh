...
export CORE_PEER_ADDRESS=10.64.39.89:7007
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/Enterprise.insurance.com/peers/peer1.Enterprise.insurance.com/tls/ca.crt
export CORE_PEER_LOCALMSPID=Enterprise-insurance-com
export CORE_PEER_MSPCONFIGPATH=/vars/keyfiles/peerOrganizations/Enterprise.insurance.com/users/Admin@Enterprise.insurance.com/msp
...
jq '.channel_group.groups.Application.groups."Enterprise-insurance-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.64.39.89","port": 7007}]},"version": "0"}}' insurancechannel_current_config.json > insurancechannel_modified_anchor_config.json
